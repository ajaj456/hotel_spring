...
<body>
	...
	<form action="update.do" method="post" enctype="multipart/form-data">
		...
		<label for="id">작성자</label><input type="text" name="id" id="wdate" value="${qna.id}" readonly="readonly"> <br>
		<label for="hit">조회수</label><input type="text" name="hit" id="hit"value="${qna.hit}" readonly="readonly"> <br>
		<button>작성</button>
