...
<body>
	<div id="all">
					...
					<td>
						<form action="inoutck.do">
							<input type="hidden" id="startDate" name="startDate"
								class="input" value="${bookedmange.startDate }"> <input
								type="hidden" id="roomNo" name="roomNo" class="input"
		...
		<div id="pageMove">
			...
			<a href="bookedlist.do?page=${jspData.totalPage }"><i
