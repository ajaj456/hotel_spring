...
public class MylistService implements ServiceInterface {
	...
	public Object service(Object obj) throws Exception {
		...
		jspData.setId(booked.getId());

		@SuppressWarnings("unchecked")
		List<Booked> list = (List<Booked>) bookedDao.mylist(jspData);
